...
- (void)initPlatfomrSupportType
{
    ...
    @{
      ...
      @(UMSocialPlatformType_Email): @[@(UMS_SHARE_TYPE_TEXT),@(UMS_SHARE_TYPE_IMAGE), @(UMS_SHARE_TYPE_IMAGE_URL), @(UMS_SHARE_TYPE_TEXT_IMAGE), @(UMS_SHARE_TYPE_WEB_LINK), @(UMS_SHARE_TYPE_MUSIC_LINK), @(UMS_SHARE_TYPE_VIDEO_LINK)],
      };
}
...
- (void)shareMusicToPlatformType:(UMSocialPlatformType)platformType
{
    ...
    //创建音乐内容对象
    NSString* thumbURL =  UMS_THUMB_IMAGE;
    UMShareMusicObject *shareObject = [UMShareMusicObject shareObjectWithTitle:@"分享标题" descr:@"分享内容描述" thumImage:thumbURL];
    //设置音乐网页播放地址
...
- (void)shareVedioToPlatformType:(UMSocialPlatformType)platformType
{
    ...
    NSString* thumbURL =  UMS_THUMB_IMAGE;
    UMShareVideoObject *shareObject = [UMShareVideoObject shareObjectWithTitle:@"分享标题" descr:@"分享内容描述" thumImage:thumbURL];
    //设置视频网页播放地址
...
- (void)shareEmoticonToPlatformType:(UMSocialPlatformType)platformType
{
    ...
    NSString* thumbURL =  UMS_THUMB_IMAGE;
    UMShareEmotionObject *shareObject = [UMShareEmotionObject shareObjectWithTitle:@"分享标题" descr:@"分享内容描述" thumImage:thumbURL];
...
- (void)shareFileToPlatformType:(UMSocialPlatformType)platformType
{
    ...
    NSString* thumbURL =  UMS_THUMB_IMAGE;
    UMShareFileObject *shareObject = [UMShareFileObject shareObjectWithTitle:@"分享标题" descr:@"分享内容描述" thumImage:thumbURL];
...
- (void)shareExternAppToPlatformType:(UMSocialPlatformType)platformType
{
    ...
    NSString* thumbURL =  UMS_THUMB_IMAGE;
    UMShareExtendObject *shareObject = [UMShareExtendObject shareObjectWithTitle:@"分享标题" descr:@"分享内容描述" thumImage:thumbURL];
