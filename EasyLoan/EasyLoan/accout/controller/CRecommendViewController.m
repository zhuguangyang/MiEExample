...
@interface CRecommendViewController ()
@property (nonatomic, strong) UIImageView *aQRCodeImgV;
@end

@implementation CRecommendViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    [self initUI];
    [self createQRCodeImageWithUrl:@"www.m-ebaby.com/front/account/app/pubreg"];
}
